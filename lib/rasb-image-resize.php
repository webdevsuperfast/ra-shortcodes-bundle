...
add_action('delete_attachment', 'rasb_delete_resized_images');

function rasb_image_resize($url, $width=null, $height=null, $crop=true, $align='c', $retina=false) {

  global $wpdb;

  // Get common vars (func_get_args() only get specified values)
  $common = rasb_common_info($url, $width, $height, $crop, $align, $retina);
...
function rasb_common_info($url, $width, $height, $crop, $align, $retina) {
...
function rasb_delete_resized_images($post_id) {
